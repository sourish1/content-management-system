<?php include "includes/admin_header.php"; ?>
    ...
    <div id="wrapper">
      ...
      <?php include "includes/admin_navigation.php"; ?>
       ...
       $published_post_counts = mysqli_num_rows($select_all_published_post);
...
<?php
  ...
  $element_text = ['Active Posts', 'Draft Posts', 'Published Posts', 'Comments', 'Pending Comments', 'Users', 'Subscribers', 'Categories'];
  $element_count = [$post_counts, $draft_post_counts, $published_post_counts, $comment_counts, $unapproved_comments_count, $user_counts, $subscriber_counts, $category_counts];
  for($i=0; $i<8; $i++)
  {
