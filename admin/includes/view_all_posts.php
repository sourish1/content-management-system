...
<form method="post">
 <input type="hidden" name="post_id" value="<?php echo $post_id; ?>">
 <?php
 echo '<td><input class="btn btn-success" type="submit" name="reset" value="Reset"></td>';
 ?>
</form>

<?php

     // echo "<td><a class='btn btn-success' onClick=\"javascript: return confirm('Are you sure?'); \" href='posts.php?reset={$post_id}'>Reset</a></td>";
